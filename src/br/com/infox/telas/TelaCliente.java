...
public class TelaCliente extends javax.swing.JInternalFrame {
    ...
    private void adicionar() {
        String sql = "insert into tbclientes(nomecli,fonecli,endcli,emalcli) values(?,?,?,?)";
        try {
    ...
    private void pesquisar_cliente() {
        String sql = "select idcli as ID, nomecli as Nome, fonecli as Fone, endcli as Endereço, emalcli as Email from tbclientes where nomecli like ?";
        try {
            pst = conexao.prepareStatement(sql);
    ...
    private void alterar() {
        String sql = "update tbclientes set nomecli=?,endcli=?,fonecli=?,emalcli=? where idcli=?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, txtCliNome.getText());
    ...
    private void remover() {
        // estrutura abaixo comfirma a remoção 
        int confirma = JOptionPane.showConfirmDialog(null, "Deseja remover esse Cliente?", "ATENÇÃO!", JOptionPane.YES_NO_OPTION);
    ...
    /**
     * Método para limpar os campos do formulario e a tabela
     */
    ...
    private void initComponents() {
        ...
        btnAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/imgAdd.png"))); // NOI18N
        ...
        btnAlterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/imgAtt.png"))); // NOI18N
        ...
        btnRemover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/imgDeletar.png"))); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(txtCliEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 385, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(31, 31, 31)
                                        .addComponent(txtCliNome, javax.swing.GroupLayout.PREFERRED_SIZE, 382, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(18, 18, 18)
